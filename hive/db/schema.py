...
hive_state = sa.Table(
    ...
    sa.Column('steem_per_mvest', sa.types.DECIMAL(5, 3), nullable=False),
    sa.Column('usd_per_steem', sa.types.DECIMAL(5, 3), nullable=False),
    sa.Column('sbd_per_steem', sa.types.DECIMAL(5, 3), nullable=False),
...
def setup(connection_url=_url):
    ...
    insert = hive_state.insert().values(block_num=0, db_version=1, steem_per_mvest=0, usd_per_steem=0, sbd_per_steem=0, dgpo='')
    conn.execute(insert)
